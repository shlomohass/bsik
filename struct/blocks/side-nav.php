    ...
    <div class="modal login-menu" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                ...
                <input type="text" name="username" placeholder="שם משתמש: כתובת אימייל" size="20" style="direction:ltr" />
                <br />
                <input type="password" name="password" placeholder="הקלד סיסמא" size="20" style="direction:ltr" />
            </div>
            <div class="modal-footer">
                <button class="button button-outline">התחבר</button>
            </div>
        </div>
    </div>
    <!-- /Modal -->
