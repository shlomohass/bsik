...
class Trace {
    ...
    public static function expose_trace() {
        ...
        $buildHtml = array();
        //Main Wrapper:
        $buildHtml[] = "<style>.iid_debuger_view * { direction:ltr; }</style><div class='iid_debuger_view' ".$styles['wrapper'].">";
        //Header:
    ...
    private static function get_expose_script() {
        ...
        $buildHtml .= " document.getElementById('iid_debuger_release').addEventListener('click', function(e) { event.stopPropagation(); document.querySelector('.iid_debuger_view').remove(); }, false);";
    ...
    private static function get_expose_header($header = '') {
        ...
        return "<div class='iid_debuger_header'".
               $styles['header'].
               "><strong>".$header."</strong><span id='iid_debuger_release' ".$styles['remover'].">X</span></div>";
    }
